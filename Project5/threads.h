...
void start_thread(void (*function)(int, int, char*), int arg1, int arg2, char* arg3) // TODO: Function changed to accept a function pointer with integer argument
{
    ...
    init_TCB(tcb_item->tcb, function, arg1, arg2, arg3, stack, STACK_SIZE);
