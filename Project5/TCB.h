...
void init_TCB (TCB_t *tcb, void *function, int arg1, int arg2, char* arg3, void *stackP, int stack_size)
...
//   3. size of the stack
{
    ...
    makecontext(&tcb->context, function, 3, arg1, arg2, arg3);// context is now cooked
}
