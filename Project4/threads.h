...
void start_thread(void (*function)(int, int), int arg1, int arg2) // TODO: Function changed to accept a function pointer with integer argument
{
    ...
    init_TCB(tcb_item->tcb, function, arg1, arg2, stack, STACK_SIZE);
